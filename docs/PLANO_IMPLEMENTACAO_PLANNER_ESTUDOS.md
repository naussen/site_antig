...
| 3 — drag-and-drop | Concluída | criação, movimentação e redimensionamento por gesto/teclado implementados |
| 4 — múltiplas semanas | Concluída | navegação, cópia sem sobrescrita e desfazer exclusão implementados |
| 5 — acabamento | Concluída | verificações automatizadas aprovadas; estado inicial validado em produção e grade preenchida validada localmente em desktop e 390 px, sem overflow |
